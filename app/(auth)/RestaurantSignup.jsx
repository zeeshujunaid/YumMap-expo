  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      await setDoc(doc(db, 'Restaurantdata', uid), {
        name, email, phone, timings: restaurantTimings, imageUrl,
      });
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ height: 250, overflow: 'hidden' }}>
              <Image
                source={selectedImage ? { uri: selectedImage } : require('../../assets/restaurantbg.jpg')}
              ...
              {!selectedImage && (
                <View style={{
                  ...
                  backgroundColor: 'rgba(255,255,255,0.7)', padding: 15,
                  borderRadius: 10
                }}>
                  <Text style={{ textAlign: 'center', fontWeight: 'bold' }}>Add Restaurant Image</Text>
                </View>
              )}
            </View>
            ...
            <View style={{
              ...
              marginTop: -40, paddingVertical: 30, paddingHorizontal: 20
            }}>
